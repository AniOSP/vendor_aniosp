...
custom_local_manifest = ".repo/local_manifests/aniosp.xml"
custom_default_revision =  os.getenv('ROOMSERVICE_DEFAULT_BRANCH', 'shizuku-12.1')
custom_dependencies = "aniosp.dependencies"
